...
public class NonReturnedWeapon extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_non_returned_weapon);
        ...
        Log.d("Workdate","Passed workdate "+workdate);
        loadData();
    }

    public void loadData() {
        pgdialog.show();
        final String url = helper.host + "/assignment.php?cate=notreturnedbydate&workdate="+workdate+"&deployer="+helper.getDataValue("sess_id");
        Log.d("URL req",url);
